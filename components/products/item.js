    ...
    return (
        <div className="col">
                ...
                <div className="card-body">
                    <Link href={`/view/${props.item.id}`}><span className={"text-center "+styles.name}>{props.item.nome}</span></Link>
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                        ...
                        <div className="btn-group">
                            <button type="button" className="btn btn-sm btn-outline-primary" onClick={addToCartHandler}>
